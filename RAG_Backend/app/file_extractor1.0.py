...
print("Using rag_storage at:", RAG_STORAGE_DIR)
...
if os.path.exists(LIBREOFFICE_PATH):
    ...
    print(f"Added LibreOffice to PATH: {LIBREOFFICE_PATH}")
else:
    print(f"Warning: LibreOffice not found at {LIBREOFFICE_PATH}")
            ...
            try:
                with open(json_files[0], "r", encoding="utf-8") as f:
                    ...
                    try:
                        ...
                        print("Raw JSON content:", raw_content[:1000])  # Print first 1000 chars for inspection
                        return None
                return result
            except Exception as e:
                print(f"Error reading/parsing JSON output for {filepath}: {e}")
                return None
        else:
